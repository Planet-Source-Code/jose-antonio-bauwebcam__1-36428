VERSION 5.00
Begin VB.UserControl O3_VerticalMenu 
   Alignable       =   -1  'True
   BackColor       =   &H80000010&
   ...
   EndProperty
   PropertyPages   =   "O3_VerticalMenu.ctx":0000
   ScaleHeight     =   204
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   133
   ToolboxBitmap   =   "O3_VerticalMenu.ctx":0032
   ...
   Begin VB.Image imgDown 
      Height          =   240
      Left            =   1500
      Picture         =   "O3_VerticalMenu.ctx":0344
      Top             =   540
      Visible         =   0   'False
      Width           =   240
   End
   Begin VB.Image imgUp 
      Height          =   240
      Left            =   1500
      Picture         =   "O3_VerticalMenu.ctx":0686
      Top             =   120
      Visible         =   0   'False
      Width           =   240
   End
End
Attribute VB_Name = "O3_VerticalMenu"
...
'******************************************************************************
  ...
  If alMenuItemsMax < 0 Then ' Or alMenuItemsMax > 12 Then
    Beep
    MsgBox "MenuItemsMax must be between 0 and ...", vbOKOnly
    Exit Property
  End If
...
Public Function Version(Optional VerDateBuild As Boolean = False) As String
  Version = App.Major & "." & App.Minor & "." & App.Revision & IIf(VerDateBuild, " - " & DATE_BUILD, "")
End Function
...
Private Sub UserControl_InitProperties()
  ...
  BACKGROUND_COLOR = m_def_BackColor ' Ambient.BackColor
  With picCache
    .Width = picMenu.Width
    .Height = (BUTTON_HEIGHT * 2) + 33
