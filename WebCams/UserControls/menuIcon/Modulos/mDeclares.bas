...
Declare Function DrawState Lib "user32" Alias "DrawStateA" _
   (ByVal hdc As Long, ByVal hBrush As Long, ByVal lpDrawStateProc As Long, ByVal lParam As Long, _
   ByVal wParam As Long, ByVal x As Long, ByVal y As Long, ByVal cX As Long, ByVal cY As Long, _
...
Declare Function ImageList_Create Lib "COMCTL32.DLL" (ByVal cX As Long, ByVal cY As Long, _
...
' Add functions:
Declare Function ImageList_Add Lib "COMCTL32.DLL" (ByVal hIml As Long, ByVal hBmp As Long, _
        ByVal hBmpMask As Long) As Long
Declare Function ImageList_AddMasked Lib "COMCTL32.DLL" (ByVal hIml As Long, ByVal hBmp As Long, _
        ByVal crMask As Long) As Long
Declare Function ImageList_AddIcon Lib "COMCTL32.DLL" (ByVal hIml As Long, ByVal hIcon As Long) As Long
Declare Function ImageList_LoadImage Lib "COMCTL32.DLL" (ByVal hInst As Long, _
...
Declare Function ImageList_Replace Lib "COMCTL32.DLL" (ByVal hIml As Long, ByVal i As Long, _
        ByVal hBmpImage As Long, ByVal hBmpMask As Long) As Long
Declare Function ImageList_ReplaceIcon Lib "COMCTL32.DLL" (ByVal hIml As Long, ByVal i As Long, _
...
Declare Function ImageList_GetIconSize Lib "COMCTL32.DLL" (ByVal hIml As Long, cX As Long, _
        cY As Long) As Long
Type IMAGEINFO
  ...
  rcImage As RECT
End Type
Declare Function ImageList_GetImageInfo Lib "COMCTL32.DLL" (ByVal hIml As Long, ByVal i As Long, _
        pImageInfo As IMAGEINFO)
    
' Create a new icon based on an image list icon:
Declare Function ImageList_GetIcon Lib "COMCTL32.DLL" (ByVal hIml As Long, ByVal i As Long, _
...
Public Sub ImageListDrawIcon(ByVal hdc As Long, ByVal hIml As Long, _
        ByVal iIconIndex As Long, ByVal lX As Long, ByVal lY As Long, _
...
Public Sub ImageListDrawIconDisabled(ByVal hdc As Long, ByVal hIml As Long, ByVal iIconIndex As Long, _
